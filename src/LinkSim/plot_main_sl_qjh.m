...
data2dsp_csv_data = readmatrix(fullfile(result_dir, 'main_sl_qjh_data2dsp_first1920.csv'));
hist_data2dsp_data = data2dsp_csv_data(:);
hist_data2dsp_data = hist_data2dsp_data(1:min(num_adcs*hist_iclk_num, numel(hist_data2dsp_data)));
...
[pdf_counts, pdf_edges] = histcounts(hist_data2dsp_data, 'BinMethod', 'integers', 'Normalization', 'probability');
...
hold off
print(gcf, fullfile(result_dir, 'main_sl_qjh_data2dsp_first1280_histogram.png'), '-dpng', '-r300');
