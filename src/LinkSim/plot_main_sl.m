...
data2dsp_csv_data = readmatrix(fullfile(result_dir, 'main_sl_data2dsp_first1920.csv'));
...
hold off
print(gcf, fullfile(result_dir, 'main_sl_data2dsp_first1280_histogram.png'), '-dpng', '-r300');
