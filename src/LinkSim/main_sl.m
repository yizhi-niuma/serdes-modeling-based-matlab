...
clear
clc
nclk=1000; % sim nclk data for the whole link
...
figure()
plot(reshape(wave_chan2(1:Sample_per_symbol*2*3000),Sample_per_symbol*2,[]));
grid on
title('Eyedigram of Channel output')
%===============================RX begin===================================
%-------Pass-----CTLE---------------------------------------------------
...
writematrix(data2dsp_csv_data, fullfile(result_dir, 'main_sl_data2dsp_first1920.csv'));
