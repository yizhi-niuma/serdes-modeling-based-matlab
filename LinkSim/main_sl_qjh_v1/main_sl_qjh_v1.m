...
adc_clock = ti_adc_clock(num_adcs, num_tnh, Sample_per_symbol);
...
for iclk=1:export_iclk_num
    cdr_phase_index = index_init_base + (iclk-1)*num_adcs*Sample_per_symbol;
    sample_index_adc = adc_clock.generateSampleIndex(cdr_phase_index);
